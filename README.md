...
- 公開登記表單：填寫單位/姓名、聯絡人、電話、Email、認購箱數或包數（可擇一或搭配，即時顯示金額）
...
金額規則（`lib/pricing.ts`）：每包 1.5kg / AU$10.10，每箱 12 包（18kg）/ AU$121.20，箱數 × $121.20 ＋ 包數 × $10.10 為應付金額。若日後價格調整，直接修改 `lib/pricing.ts` 即可。
